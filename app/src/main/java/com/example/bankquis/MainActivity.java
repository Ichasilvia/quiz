...
public class MainActivity extends AppCompatActivity {
    ...
    String[] pertanyaan_kuis = new String[]{
            "1. Bahasa inggris dari pesawat adalah…",
            "2. Table artinya adalah…",
            "3. Arti dari My mother adalah ….",
            "4. Kita mengucapkan good morning pada saat... hari",
    };

    //pilihan jawaban a, b, c, d
    String[] pilihan_jawaban = new String[]{
            "Bird", "plant", "Bag", "Plane",
             "kursi", "meja", "penggaris", "buku",
            "ayah", "kakak", "bibi", "ibu",
            "pagi", "siang", "malam", "petang",
    };
